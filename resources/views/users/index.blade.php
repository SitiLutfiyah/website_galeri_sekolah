    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $user->email }}</td>
                <td>
                    <button class="btn btn-warning me-2" onclick="confirmEdit('{{ $user->id }}', '{{ $user->name }}')"><i data-feather="edit"></i> Edit</button>
                    <button class="btn btn-danger" onclick="confirmDelete('{{ $user->id }}', '{{ $user->name }}')"><i data-feather="trash"></i> Hapus</button>
                </td>
            </tr>
            @endforeach
        </tbody>
